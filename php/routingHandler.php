    ...
    if (! empty($urlParams['actionCode'])) {
        switch ($urlParams['actionCode']) {
            ...
            case 9:
                ...
                $animals = $animalQuery->filterByUserid($sessionHandler->getSessionUser())
                    ->find();
            ...
            case 13:
                ...
                if (! empty($animalId)) {
                    ...
                    $animalObject->setName($animalData['Name'])
                        ->setBirthday($animalData['Birthday'])
                        ->setSexid($animalData['Sexid'])
                        ->setFurcolourid($animalData['Furcolourid'])
                        ->setEyecolourid($animalData['Eyecolourid'])
                        ->setSpeciesid($animalData['Speciesid'])
                        ->setSize($animalData['Size'])
                        ->setRaceid($animalData['Raceid'])
                        ->setSpecification($animalData['Specification'])
                        ->setImage($imageId . '.png');
                    $animalObject->save();
                }
