...
*/
abstract class Species implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SpeciesTableMap';
    ...
    /**
     * Compares this with another <code>Species</code> instance.  If
     * <code>obj</code> is an instance of <code>Species</code>, delegates to
     * <code>equals(Species)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Species The current object, for fluid interface
     */
    ...
    public function setSpecies($v)
    {
        ...
        if ($this->species !== $v) {
            $this->species = $v;
            $this->modifiedColumns[SpeciesTableMap::COL_SPECIES] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[SpeciesTableMap::COL_CODE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[SpeciesTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpeciesTableMap::translateFieldName('Species', TableMap::TYPE_PHPNAME, $indexType)];
            $this->species = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpeciesTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpeciesTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SpeciesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Species'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSpeciesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Species::setDeleted()
     * @see Species::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpeciesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpeciesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpeciesTableMap::COL_SPECIES)) {
            $modifiedColumns[':p' . $index++]  = 'species';
        }
        if ($this->isColumnModified(SpeciesTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(SpeciesTableMap::COL_DESCRIPTION)) {
    ...
    {
        $pos = SpeciesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Species'][$this->hashCode()] = true;
        $keys = SpeciesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSpecies(),
            $keys[1] => $this->getCode(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpeciesTableMap::COL_SPECIES)) {
            $criteria->add(SpeciesTableMap::COL_SPECIES, $this->species);
        }
        if ($this->isColumnModified(SpeciesTableMap::COL_CODE)) {
            $criteria->add(SpeciesTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(SpeciesTableMap::COL_DESCRIPTION)) {
            $criteria->add(SpeciesTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildSpeciesQuery::create();
        $criteria->add(SpeciesTableMap::COL_SPECIES, $this->species);
    ...
    /**
     * Generic method to set the primary key (species column).
     *
    ...
    {
        return (string) $this->exportTo(SpeciesTableMap::DEFAULT_STRING_FORMAT);
    }
