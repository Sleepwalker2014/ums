...
/**
 * Base class that represents a row from the 'sexes' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Sexes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SexesTableMap';
    ...
    /**
     * Initializes internal state of Base\Sexes object.
     */
    ...
    /**
     * Compares this with another <code>Sexes</code> instance.  If
     * <code>obj</code> is an instance of <code>Sexes</code>, delegates to
     * <code>equals(Sexes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Sexes The current object, for fluid interface
     */
     ...
     * @return $this|\Sexes The current object (for fluent API support)
     */
    public function setSex($v)
    {
        ...
        if ($this->sex !== $v) {
            $this->sex = $v;
            $this->modifiedColumns[SexesTableMap::COL_SEX] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[SexesTableMap::COL_CODE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[SexesTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SexesTableMap::translateFieldName('Sex', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sex = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SexesTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SexesTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SexesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Sexes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSexesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSexesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SexesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SexesTableMap::COL_SEX)) {
            $modifiedColumns[':p' . $index++]  = 'sex';
        }
        if ($this->isColumnModified(SexesTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(SexesTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO sexes (%s) VALUES (%s)',
    ...
    {
        $pos = SexesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Sexes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sexes'][$this->hashCode()] = true;
        $keys = SexesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSex(),
            $keys[1] => $this->getCode(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SexesTableMap::COL_SEX)) {
            $criteria->add(SexesTableMap::COL_SEX, $this->sex);
        }
        if ($this->isColumnModified(SexesTableMap::COL_CODE)) {
            $criteria->add(SexesTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(SexesTableMap::COL_DESCRIPTION)) {
            $criteria->add(SexesTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildSexesQuery::create();
        $criteria->add(SexesTableMap::COL_SEX, $this->sex);
    ...
    /**
     * Generic method to set the primary key (sex column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sexes (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSex(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Sexes Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSexes is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSexes The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(SexesTableMap::DEFAULT_STRING_FORMAT);
    }
