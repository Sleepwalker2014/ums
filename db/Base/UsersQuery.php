...
abstract class UsersQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_USER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_USER, $keys, Criteria::IN);
    }
    ...
    public function filterByUser($user = null, $comparison = null)
    {
        if (is_array($user)) {
            $useMinMax = false;
            if (isset($user['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_USER, $user['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($user['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_USER, $user['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_USER, $user, $comparison);
    }
    ...
    public function filterByAnimals($animals, $comparison = null)
    {
        if ($animals instanceof \Animals) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_USER, $animals->getUserid(), $comparison);
    ...
    {
        if ($users) {
            $this->addUsingAlias(UsersTableMap::COL_USER, $users->getUser(), Criteria::NOT_EQUAL);
        }
