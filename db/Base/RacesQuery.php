...
/**
 * Base class that represents a query for the 'races' table.
 *
 *
 *
 ...
 * @method     ChildRacesQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 ...
 *
 */
abstract class RacesQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\RacesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Races', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildRacesQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildRacesQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildRacesQuery) {
            return $criteria;
        }
        $query = new ChildRacesQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildRaces|array|mixed the result, formatted by the current formatter
     */
     ...
     *
     * @return ChildRaces A model object, or null if the key is not found
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(RacesTableMap::COL_RACE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(RacesTableMap::COL_RACE, $keys, Criteria::IN);
    }
    ...
    public function filterByRace($race = null, $comparison = null)
    {
        if (is_array($race)) {
            $useMinMax = false;
            if (isset($race['min'])) {
                $this->addUsingAlias(RacesTableMap::COL_RACE, $race['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($race['max'])) {
                $this->addUsingAlias(RacesTableMap::COL_RACE, $race['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RacesTableMap::COL_RACE, $race, $comparison);
    }
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RacesTableMap::COL_CODE, $code, $comparison);
    }
     ...
     *
     * @param   ChildRaces $races Object to remove from the list of results
     *
     * @return $this|ChildRacesQuery The current query, for fluid interface
     */
    public function prune($races = null)
    {
        if ($races) {
            $this->addUsingAlias(RacesTableMap::COL_RACE, $races->getRace(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            RacesTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(RacesTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            RacesTableMap::removeInstanceFromPool($criteria);
