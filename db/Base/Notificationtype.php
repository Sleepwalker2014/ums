...
/**
 * Base class that represents a row from the 'notificationType' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Notificationtype implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\NotificationtypeTableMap';
    ...
    /**
     * Compares this with another <code>Notificationtype</code> instance.  If
     * <code>obj</code> is an instance of <code>Notificationtype</code>, delegates to
     * <code>equals(Notificationtype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Notificationtype The current object, for fluid interface
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[NotificationtypeTableMap::COL_CODE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[NotificationtypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NotificationtypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = NotificationtypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Notificationtype'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildNotificationtypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Notificationtype::setDeleted()
     * @see Notificationtype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildNotificationtypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NotificationtypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NotificationtypeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO notificationType (%s) VALUES (%s)',
    ...
    {
        $pos = NotificationtypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationtypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(NotificationtypeTableMap::COL_DESCRIPTION, $this->description);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Notificationtype (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Notificationtype Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(NotificationtypeTableMap::DEFAULT_STRING_FORMAT);
    }
